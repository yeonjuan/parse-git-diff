(function (global, factory) {
  ...
  function parseChunk(context) {
    ...
    return Object.assign(Object.assign({ type: 'Chunk' }, chunkHeader), {
      changes,
    });
  }
  function parseExtendedHeader(ctx) {
    ...
    if (
      type === ExtendedHeader.RenameFrom ||
      type === ExtendedHeader.RenameTo
    ) {
      return {
        type,
  ...
  function parseChangeMarkers(context) {
    var _a, _b;
    const deleted =
      (_a = parseMarker(context, '--- ')) === null || _a === void 0
        ? void 0
        : _a.replace('a/', '');
    const added =
      (_b = parseMarker(context, '+++ ')) === null || _b === void 0
        ? void 0
        : _b.replace('b/', '');
